...
$submittedAt = (new DateTimeImmutable('now', new DateTimeZone('America/Detroit')))->format('M j, Y g:i A T');
...
$templateVars = [
    ...
    'site_name' => escapeHtml($config['from_name'] ?? 'Peninsula Pavers'),
    'site_url' => escapeHtml($config['site_url'] ?? 'https://peninsulapavers.com'),
    'site_phone' => escapeHtml($config['site_phone'] ?? '(231) 421-8480'),
    'site_phone_href' => escapeHtml($config['site_phone_href'] ?? '+12314218480'),
];
